...
{
public:
  VSDGeometry(unsigned id, unsigned level, unsigned geomFlags) :
...
void libvisio::VSDGeometry::handle(VSDCollector *collector)
{
...
{
  return new VSDGeometry(m_id, m_level, m_geomFlags);
}


void libvisio::VSDMoveTo::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDLineTo::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDArcTo::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDEllipse::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDEllipticalArcTo::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDNURBSTo1::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDNURBSTo2::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDPolylineTo1::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDPolylineTo2::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDSplineStart::handle(VSDCollector *collector)
{
...
void libvisio::VSDSplineKnot::handle(VSDCollector *collector)
{
...
void libvisio::VSDInfiniteLine::handle(VSDCollector *collector)
{
  collector->collectSplineEnd();
...
void libvisio::VSDGeometryList::addGeometry(unsigned id, unsigned level, unsigned char geomFlags)
{
  m_elements[id] = new VSDGeometry(id, level, geomFlags);
}
